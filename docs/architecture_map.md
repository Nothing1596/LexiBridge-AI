...
- Task 9C.4V defines that replacement contract as an async document workflow
  ...
  local formal worker dispatch and transport mapping. No formal query/route,
  frontend cutover, OpenAPI entry, or production worker runtime exists yet.
