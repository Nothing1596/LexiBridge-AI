...
- Task 9C.4V defines that replacement contract as an async document workflow
  ...
  and internal document processing/root finalization. No formal worker
  dispatch, query/route, frontend cutover, or OpenAPI entry exists yet.
