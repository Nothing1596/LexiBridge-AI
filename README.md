...
two attempt-fenced requeues, and keeps historical job budgets unchanged. Formal API browser E2E,
frontend polling/cutover, legacy disablement, PostgreSQL, a supervised worker,
and live-provider operation remain future work.
